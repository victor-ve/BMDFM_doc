...
void func__wlen_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
...
void func__wprnwidth_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  ret_dat->disable_ptr=1;
  tmp_ptr=*((ULO**)dat_ptr);
...
void func__wfromstr_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  ret_dat->disable_ptr=1;
  tmp_ptr=*((ULO**)dat_ptr);
...
void func__wtostr_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  ret_dat->disable_ptr=1;
  tmp_ptr=*((ULO**)dat_ptr);
...
void func__wcat_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  (*(fcall)*tmp_ptr)(_RT_CTRL_comma tmp_ptr+1,ret_dat);
  if(noterror())
    wlcat((WCR**)&ret_dat->svalue,(WCR*)op_a);
  free_string(&op_a);
  return;
}
...
void func__wcmp_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='I';
    ret_dat->value.ival=wcmp_s((WCR*)op_a,(WCR*)ret_dat->svalue);
  }
  free_string(&op_a);
  return;
}
...
void func__wspace_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wreplicate(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
  ...
  if(noterror()){
    ret_dat->single=1;
    ret_dat->type='S';
    wreplicate((WCR**)&ret_dat->svalue,(WCR*)ret_dat->svalue,ret_dat->
      value.ival);
  }
  return;
}
void func__wreplicate_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='S';
    wreplicate((WCR**)&ret_dat->svalue,(WCR*)op_a,ret_dat->value.ival);
  }
  free_string(&op_a);
  return;
}
...
void func__wsubstr_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  SLO op_b;
  ...
  tmp_ptr=*((ULO**)(dat_ptr+1));
  (*(fcall)*tmp_ptr)(_RT_CTRL_comma tmp_ptr+1,ret_dat);
  op_b=ret_dat->value.ival;
  tmp_ptr=*((ULO**)(dat_ptr+2));
  (*(fcall)*tmp_ptr)(_RT_CTRL_comma tmp_ptr+1,ret_dat);
  if(noterror()){
    ret_dat->type='S';
    wsubstr((WCR**)&ret_dat->svalue,(WCR*)op_a,op_b,ret_dat->value.ival);
  }
  free_string(&op_a);
  return;
}
...
void func__wleft_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='S';
    wleft((WCR**)&ret_dat->svalue,(WCR*)op_a,ret_dat->value.ival);
  }
  free_string(&op_a);
  return;
}
...
void func__wleftr_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='S';
    wleftr((WCR**)&ret_dat->svalue,(WCR*)op_a,ret_dat->value.ival);
  }
  free_string(&op_a);
  return;
}
...
void func__wright_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='S';
    wright((WCR**)&ret_dat->svalue,(WCR*)op_a,ret_dat->value.ival);
  }
  free_string(&op_a);
  return;
}
...
void func__wrightl_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='S';
    wrightl((WCR**)&ret_dat->svalue,(WCR*)op_a,ret_dat->value.ival);
  }
  free_string(&op_a);
  return;
}
...
void func__wat_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='I';
    ret_dat->value.ival=wat((WCR*)op_a,(WCR*)ret_dat->svalue);
  }
  free_string(&op_a);
  return;
}
...
void func__wrat_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='I';
    ret_dat->value.ival=wrat((WCR*)op_a,(WCR*)ret_dat->svalue);
  }
  free_string(&op_a);
  return;
}
...
void func__wstrtran_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL,*op_b=NULL;
  ret_dat->disable_ptr=1;
  tmp_ptr=*((ULO**)dat_ptr);
  (*(fcall)*tmp_ptr)(_RT_CTRL_comma tmp_ptr+1,ret_dat);
  equ(&op_a,ret_dat->svalue);
  tmp_ptr=*((ULO**)(dat_ptr+1));
  (*(fcall)*tmp_ptr)(_RT_CTRL_comma tmp_ptr+1,ret_dat);
  equ(&op_b,ret_dat->svalue);
  tmp_ptr=*((ULO**)(dat_ptr+2));
  (*(fcall)*tmp_ptr)(_RT_CTRL_comma tmp_ptr+1,ret_dat);
  if(noterror())
    wstrtran((WCR**)&ret_dat->svalue,(WCR*)op_a,(WCR*)op_b,(WCR*)ret_dat->
      svalue);
  free_string(&op_a);
  free_string(&op_b);
  return;
...
void func__wltrim_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wrtrim_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__walltrim_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wpack_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wnotempty_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__whead_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wtail_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wlsp_head_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wlsp_tail_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wupper_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wlower_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wrev_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  ret_dat->disable_ptr=1;
  dat_ptr=*((ULO**)dat_ptr);
  (*(fcall)*dat_ptr)(_RT_CTRL_comma dat_ptr+1,ret_dat);
...
void func__wpadl_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='S';
    wpadl((WCR**)&ret_dat->svalue,(WCR*)op_a,ret_dat->value.ival);
  }
  free_string(&op_a);
  return;
}
...
void func__wpadr_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='S';
    wpadr((WCR**)&ret_dat->svalue,(WCR*)op_a,ret_dat->value.ival);
  }
  free_string(&op_a);
  return;
}
...
void func__wpadc_j(_CONST_VOID_PTR_RT_CTRL_comma const ULO *dat_ptr,
   struct fastlisp_data *ret_dat){
  const ULO *tmp_ptr;
  CHR *op_a=NULL;
  ret_dat->disable_ptr=1;
  ...
  if(noterror()){
    ret_dat->type='S';
    wpadc((WCR**)&ret_dat->svalue,(WCR*)op_a,ret_dat->value.ival);
  }
  free_string(&op_a);
  return;
}
...
#ifdef _WCHAR_IN_ISA_COPS_
  CHR *ISA_COPs=NULL,*temp=NULL;
  char buff[100];
  const char *fmt="(%s %d %c \"%s\" %ld %ld 0 0 0)";
  _internal_ISA_COPs_get(&ISA_COPs);
  snprintf(buff,sizeof(buff),fmt,"WLEN",1,'I',"S",
    (SLO)&func__wlen,(SLO)&func__wlen_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WPRNWIDTH",1,'I',"S",
    (SLO)&func__wprnwidth,(SLO)&func__wprnwidth_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WFROMSTR",1,'S',"S",
    (SLO)&func__wfromstr,(SLO)&func__wfromstr_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"W",1,'S',"S",
    (SLO)&func__wfromstr,(SLO)&func__wfromstr_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WTOSTR",1,'S',"S",
    (SLO)&func__wtostr,(SLO)&func__wtostr_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WCAT",2,'S',"SS",
    (SLO)&func__wcat,(SLO)&func__wcat_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WCMP",2,'I',"SS",
    (SLO)&func__wcmp,(SLO)&func__wcmp_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WSPACE",1,'S',"I",
    (SLO)&func__wspace,(SLO)&func__wspace_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WREPLICATE",2,'S',"SI",
    (SLO)&func__wreplicate,(SLO)&func__wreplicate_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WSUBSTR",3,'S',"SII",
    (SLO)&func__wsubstr,(SLO)&func__wsubstr_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WLEFT",2,'S',"SI",
    (SLO)&func__wleft,(SLO)&func__wleft_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WLEFTR",2,'S',"SI",
    (SLO)&func__wleftr,(SLO)&func__wleftr_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WRIGHT",2,'S',"SI",
    (SLO)&func__wright,(SLO)&func__wright_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WRIGHTL",2,'S',"SI",
    (SLO)&func__wrightl,(SLO)&func__wrightl_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WAT",2,'I',"SS",
    (SLO)&func__wat,(SLO)&func__wat_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WRAT",2,'I',"SS",
    (SLO)&func__wrat,(SLO)&func__wrat_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WSTRTRAN",3,'S',"SSS",
    (SLO)&func__wstrtran,(SLO)&func__wstrtran_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WLTRIM",1,'S',"S",
    (SLO)&func__wltrim,(SLO)&func__wltrim_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WRTRIM",1,'S',"S",
    (SLO)&func__wrtrim,(SLO)&func__wrtrim_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WALLTRIM",1,'S',"S",
    (SLO)&func__walltrim,(SLO)&func__walltrim_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WPACK",1,'S',"S",
    (SLO)&func__wpack,(SLO)&func__wpack_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WNOTEMPTY",1,'I',"S",
    (SLO)&func__wnotempty,(SLO)&func__wnotempty_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WHEAD",1,'S',"S",
    (SLO)&func__whead,(SLO)&func__whead_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WTAIL",1,'S',"S",
    (SLO)&func__wtail,(SLO)&func__wtail_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WLSP_HEAD",1,'S',"S",
    (SLO)&func__wlsp_head,(SLO)&func__wlsp_head_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WLSP_TAIL",1,'S',"S",
    (SLO)&func__wlsp_tail,(SLO)&func__wlsp_tail_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WUPPER",1,'S',"S",
    (SLO)&func__wupper,(SLO)&func__wupper_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WLOWER",1,'S',"S",
    (SLO)&func__wlower,(SLO)&func__wlower_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WREV",1,'S',"S",
    (SLO)&func__wrev,(SLO)&func__wrev_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WPADL",2,'S',"SI",
    (SLO)&func__wpadl,(SLO)&func__wpadl_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WPADR",2,'S',"SI",
    (SLO)&func__wpadr,(SLO)&func__wpadr_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
  snprintf(buff,sizeof(buff),fmt,"WPADC",2,'S',"SI",
    (SLO)&func__wpadc,(SLO)&func__wpadc_j);
  cat(&ISA_COPs,get_std_buff(&temp,buff));
